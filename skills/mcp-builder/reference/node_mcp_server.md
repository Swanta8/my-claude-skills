...
> **Start here:** copy `../templates/node/` and run `npm install`. This guide is the reference for *why* the template looks the way it does and how to extend it.
...
- [ ] `npx @modelcontextprotocol/inspector node dist/index.js` starts and lists all tools
...
- [ ] Do NOT test by running `node dist/index.js` directly — stdio servers hang waiting for stdin